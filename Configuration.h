...
#define CUSTOM_MACHINE_NAME "Oghma Print"
 ...
 */
// * I CHANGED THIS BECAUSE I FOUND IT ANNOYING NOT TO BE ABLE TO TEST WITHOUT A HEATED NOZZLE
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.13   // Z offset: -below +above  [the nozzle]
